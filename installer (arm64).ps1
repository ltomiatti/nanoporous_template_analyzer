...
winget install Microsoft.VCRedist.2022.arm64 # Pacotes do Microsof Visual C++ 2022 para sistema arm64.
pip install pillow
pip install jes4py # Se surgir erro nessa etapa, reinicie após instalar o Microsof Visual C++ 2022.
