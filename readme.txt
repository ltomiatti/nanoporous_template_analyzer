...
1. Python 3.X.
2. Microsoft Visual C++ 14.0 or greater (get it with "Microsoft C++ Build Tools": https://visualstudio.microsoft.com/visual-cpp-build-tools/). Select "Desktop development with C++" during installation. Necessary to jes4py package.
